...
#import data
energydata_complete <- read_csv("/Users/henrysurjono/Documents/MATH 531T/energydata_complete.csv")
...
#using the Bartlett Test to check for constant variance
groups = c(rep(1,658),rep(2,658),rep(3,658),rep(4,658),rep(5,658))
bartlett.test(Appliances ~ groups,data = data_subset)
...
#plot the forecast of our volitlity
par(mfrow = c(2,2))
...
#the forcasted on the differenced relative change
